...
final class MyTableViewCell: UITableViewCell {
    ...
    //MARK: - 생성자 셋팅, viewDidLoad와 비슷한 역할
    // 지정생성자 재정의
    ...
    // 상위의 지정생성자를 재정의를 할때는 상위의 필수생성자는 반드시 필수생성자를 구현 해주어야 한다
    // => 지정생성자를 재정의를 할때는 필수생성자가 자동으로 상속이 되지 않기 때문에
    ...
    override func updateConstraints() {
        setConstraints()
        // updateConstraints의 super는 나중에 실행
    ...
    override func layoutSubviews() {
        ...
        // self.mainImageView.frame.width가 결정이 되는 순간이 layoutSubviews 이후이기 때문에
        // 여기서 cornerRadius를 주었다. (완벽한 원을 만들기 위해 어쩔수 없음)
